...
- Martingale residuals (диагностика линейности для первого предиктора)
- Скорректированные кривые выживаемости (если выбрана ковариата)
...
**Графики (3):**
- ROC-кривая
- DCA (Decision Curve Analysis) с линиями "Treat All" и "Treat None"
- Калибровочная кривая с Brier Score
...
**Графики (4):**
- Столбчатая диаграмма коэффициентов отобранных фич (дополнительно топ-30 всех)
...
| `SHAP analysis` | Включить расчёт SHAP (может быть медленным) |
...
| **System Prompt** | Системный промпт — инструкция AI. Содержит контекст проекта, датасета и историю анализов |
...
- `pd`, `np`, `plt` — стандартные библиотеки
